...
La diferencia en 2022 con el grupo con la renta media es de un 21% con el grupo de mayor renta neta media (los mayores de 65).Esto es especialmente llamativo, ya que la diferencia con el grupo de mayor renta neta media en 2008 era de un 16’86%. También llama la atención cómo la renta de los jóvenes no sólo queda muy lejos de la del resto de grupos de edad, sino que además esta diferencia no disminuye a lo largo del tiempo: 
...
Como podemos observar, no sólo es que los jóvenes tengan una renta disponible menor, si no que cada vez se queda más atrás.
Una vez comprobado que los jóvenes son cada vez relativamente más pobres, vamos ahora a comprobar si al menos los jóvenes ganan poder adquisitivo a lo largo del tiempo, pues los anteriores datos eran nominales. Para ello, vamos a contrastar la anterior evolución de los salarios de los jóvenes con la inflación.

---

# Variación del Indice de Precios de la Vivienda

Vamos a analizar la variación del IPV
